...
**LLM-as-judge is one technique** for meeting the validation/accuracy requirement of Art. 15 — the `JudgeService` in this project is a concrete implementation (relevancy + groundedness check with a stronger model), not a mandated method.
